...
<!--          </MenuItem>-->
          ...
          <MenuItem to="/routeMap" name="routeMap">
            <span>疫情出行评估</span>
          </MenuItem>
        </Menu>
      </Sider>
      <Layout>
        <Header
          :style="{background: '#fff', height: '80px',boxShadow: '0 2px 3px 2px rgba(0,0,0,.1)'}"
          class="layout-header-bar"
        >
          <div class="layout-header-title" id="layout-header-title">上海大学 nCoV-2019 风险评估平台</div>
        </Header>
        <Content
