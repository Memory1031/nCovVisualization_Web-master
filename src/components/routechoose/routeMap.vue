<template>
  <div>
      ...
      <div style="height:520px;overflow-y:auto">
        ...
        >
          ...
          <li v-if="sitem.type==1" :class="{noExpand:(!(expand==index)),isExpand:(expand==index)}">
            ...
            <div style="position:relative;right:0px" class="table">
              <Table row-key="id" @on-row-click="toggleTableExpand" :columns="columns" :data="sitem.line" border :indent-size="0"></Table>
            </div>
          </li>
    ...
    <Modal v-model="modal1" width="50">
      <city-detail v-bind:factor="cityname" style="height:400px;position:relative;left:10%;top:20px;"></city-detail>
      <div slot="footer">
